...
export default function ClockPanel() {
  const { isRunning, startedAtSec, accumulatedSec } = useAppStore(s => s.gameClock);
  ...
  return (
      ...
      <Typography variant="body2">Sub Clock: {subFormattedTime}</Typography>
            ...
            {!isRunning ? (
                ...
                <Button variant="contained" color="inherit" onClick={handleOpenResetConfirm}>Reset</Button>
            </Box>
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="reset-dialog-description">
                        Are you sure you want to reset the game clock? This will also reset all player minutes played.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
